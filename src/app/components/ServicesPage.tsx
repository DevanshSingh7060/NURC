...
const services = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1585829365295-ab7cd400c167?w=800&h=900&fit=crop&auto=format',
    color: '#006D7A',
  },
  {
    icon: Search,
    ...
    image:
      'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&h=900&fit=crop&auto=format',
    color: '#0A2540',
  },
  {
    icon: Settings,
    ...
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=900&fit=crop&auto=format',
    color: '#3B6E8A',
  },
  {
    icon: Users,
    ...
    image:
      'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=900&fit=crop&auto=format',
    color: '#5B8A5E',
  },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="mb-6 font-display text-[clamp(28px,4vw,48px)] font-bold text-nurc-navy leading-[1.15] max-w-[700px]">
                Daily Curated News & Information for Corporate India
              </h1>
              <p className="text-muted-foreground mb-8 text-[17px] leading-[1.85] max-w-[620px]">
                For over 26 years, NURC MediaNext has provided subscription-based daily news
                intelligence to Fortune 500 organizations, top MNCs, and growing Indian companies.
                Our service keeps executives, decision-makers, and corporate communications teams
                informed about their industry, organization, and competition.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold border border-border transition-all hover:bg-gray-50 text-nurc-navy font-heading"
                >
                  Contact Us
                </Link>
              </div>
                  ...
                  <div className="grid lg:grid-cols-5 gap-0">
                    ...
                    >
                      ...
                      <div className="relative [text-shadow:0_1px_4px_rgba(0,0,0,0.45)]">
                        ...
                        <div className="text-xs font-bold uppercase text-white/60 mb-2 tracking-[0.12em] font-heading">
                          {service.subtitle}
                        </div>
                        <h3 className="text-white mb-3 font-display text-[clamp(20px,2.5vw,26px)] font-bold leading-[1.25]">
                          {service.title}
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="lg:col-span-3 p-8">
                      <p className="text-muted-foreground mb-6 text-[15px] leading-[1.8]">
                        {service.description}
                      </p>
                      <div className="space-y-2.5">
                        {service.features.map((feature, j) => (
                          <div key={j} className="flex items-start gap-2.5">
                            ...
                            />
                            <span className="text-sm text-nurc-navy leading-[1.5]">{feature}</span>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-3 max-w-xl mx-auto text-[15px]">
              We provide daily news intelligence across these industry verticals. Each sector is
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4">
            {sectors.map((sector, i) => (
              ...
              >
                ...
                />
                <div className="font-semibold text-sm font-heading text-nurc-navy">
                  {sector.name}
                </div>
              </Link>
            ))}
      ...
      <section className="py-20 bg-nurc-navy">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white/90 text-xs font-bold uppercase tracking-wider mb-6 font-heading">
            <Clock size={12} />
            15-Day Free Trial
          </div>
          <h2 className="text-white mb-5 font-display text-[clamp(24px,3.5vw,38px)] font-bold leading-[1.2]">
            Try Our Intelligence Service — No Commitment
          </h2>
          <p className="text-white/60 mb-8 text-[16px] leading-[1.75]">
            Request a 15-day free trial for your organization. Multiple users can evaluate our daily
            sector-specific updates with absolutely no obligation to subscribe.
          </p>
          <Link
            to="/contact?intent=trial"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl font-semibold text-white transition-all hover:opacity-90 bg-nurc-teal font-heading"
          >
            Request Free Trial
            <ArrowRight size={16} />
          </Link>
